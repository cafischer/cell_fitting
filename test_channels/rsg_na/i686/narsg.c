...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 68, 4);
 	...
 	ivoc_help("help ?1 narsg /media/caro/Daten/Phd/DAP-Project/cell_fitting/test_channels/rsg_na/i686/narsg.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 136 in file narsg.mod:\n	SOLVE seqinitial\n"); nrn_complain(_p); abort_run(error);}
 }
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 128 in file narsg.mod:\n	SOLVE activation METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
