...
#define hinf _p[8]
#define htau _p[9]
#define tadj_act _p[10]
#define tadj_inact _p[11]
#define Dm _p[12]
#define Dh _p[13]
#define v _p[14]
#define _g _p[15]
...
extern Memb_func* memb_func;
 ...
 "setdata_nap2", _hoc_setdata,
 "settables_nap2", _hoc_settables,
 0, 0
};
...
#define celsius_channel celsius_channel_nap2
 double celsius_channel = 22;
#define q10_inact q10_inact_nap2
 double q10_inact = 1.3;
#define q10_act q10_act_nap2
 double q10_act = 2.7;
#define usetable usetable_nap2
 double usetable = 1;
 ...
 "q10_act_nap2", &q10_act_nap2,
 "q10_inact_nap2", &q10_inact_nap2,
 "celsius_channel_nap2", &celsius_channel_nap2,
 "usetable_nap2", &usetable_nap2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 16, 4);
 	...
 	ivoc_help("help ?1 nap2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/nap.mod\n");
