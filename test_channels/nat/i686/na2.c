...
extern Memb_func* memb_func;
 ...
 "setdata_na2", _hoc_setdata,
 "efun_na2", _hoc_efun,
 "rates_na2", _hoc_rates,
 "trates_na2", _hoc_trates,
 0, 0
};
#define efun efun_na2
...
#define q10 q10_na2
 double q10 = 2.3;
#define qinf qinf_na2
 double qinf = 6.2;
#define qi qi_na2
 double qi = 5;
#define qa qa_na2
 double qa = 9;
#define tadj_na2 _thread1data[0]
#define tadj _thread[_gth]._pval[0]
#define temp temp_na2
 double temp = 23;
#define thinf thinf_na2
 double thinf = -65;
#define thi2 thi2_na2
 double thi2 = -75;
#define thi1 thi1_na2
 double thi1 = -50;
#define tha tha_na2
 double tha = -35;
#define usetable usetable_na2
 double usetable = 1;
#define vshift vshift_na2
 double vshift = -10;
#define vmax vmax_na2
 double vmax = 100;
#define vmin vmin_na2
 double vmin = -120;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 na2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/test_channels/Nat/i686/na2.mod\n");
