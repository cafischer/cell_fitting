...
#define Dn _p[12]
#define Dl _p[13]
#define tadj_act _p[14]
#define tadj_inact _p[15]
#define v _p[16]
#define _g _p[17]
...
#define gmn gmn_ka
 double gmn = 0.55;
#define lscale lscale_ka
 double lscale = 1;
#define lmin lmin_ka
 double lmin = 2;
#define nmin nmin_ka
 double nmin = 0.1;
#define nscale nscale_ka
 double nscale = 1;
#define pw pw_ka
 double pw = -1;
#define q10_inact q10_inact_ka
 double q10_inact = 1;
#define q10_act q10_act_ka
 double q10_act = 5;
#define qq qq_ka
 double qq = 5;
#define temp temp_ka
...
#define zetan zetan_ka
 ...
 "lmin_ka", &lmin_ka,
 "lscale_ka", &lscale_ka,
 "q10_act_ka", &q10_act_ka,
 "q10_inact_ka", &q10_inact_ka,
 "temp_ka", &temp_ka,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 18, 4);
 	...
 	ivoc_help("help ?1 ka /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels/stellate/i686/ka.mod\n");
