...
extern Memb_func* memb_func;
 ...
 "efun_caHVA", _hoc_efun,
 "rates_caHVA", _hoc_rates,
 "trates_caHVA", _hoc_trates,
 0, 0
};
#define efun efun_caHVA
...
#define _gth 0
#define q10_inact q10_inact_caHVA
 double q10_inact = 2;
#define q10_act q10_act_caHVA
 double q10_act = 5.9;
#define tadj_inact_caHVA _thread1data[0]
#define tadj_inact _thread[_gth]._pval[0]
#define tadj_act_caHVA _thread1data[1]
#define tadj_act _thread[_gth]._pval[1]
#define temp temp_caHVA
 double temp = 23;
#define usetable usetable_caHVA
 double usetable = 1;
#define vshift vshift_caHVA
 double vshift = 0;
#define vmax vmax_caHVA
 double vmax = 100;
#define vmin vmin_caHVA
 double vmin = -120;
 ...
 "vshift_caHVA", &vshift_caHVA,
 "temp_caHVA", &temp_caHVA,
 "q10_act_caHVA", &q10_act_caHVA,
 "q10_inact_caHVA", &q10_inact_caHVA,
 "vmin_caHVA", &vmin_caHVA,
 "vmax_caHVA", &vmax_caHVA,
 "tadj_act_caHVA", &tadj_act_caHVA,
 "tadj_inact_caHVA", &tadj_inact_caHVA,
 "usetable_caHVA", &usetable_caHVA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 caHVA /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels/stellate/i686/caHVA.mod\n");
