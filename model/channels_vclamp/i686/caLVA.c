...
extern Memb_func* memb_func;
 ...
 "setdata_caLVA2", _hoc_setdata,
 "efun_caLVA2", _hoc_efun,
 "evaluate_fct_caLVA2", _hoc_evaluate_fct,
 "ghk_caLVA2", _hoc_ghk,
 "nongat_caLVA2", _hoc_nongat,
 0, 0
};
#define efun efun_caLVA2
#define ghk ghk_caLVA2
#define nongat nongat_caLVA2
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 19, 3);
 	...
 	ivoc_help("help ?1 caLVA2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/caLVA.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = 0.0 ;
   ica2 = pbar * m * m * h * ghk ( _threadargscomma_ v , cai , cao ) ;
   }
 _current += ica;
