...
if __name__ == '__main__':
    ...
    v_model, t_model, _ = simulate_model(cell, 'rampIV', ramp_amp, t_data[-1], **standard_sim_params)
    ...
    plot_sag_vs_steady_state_on_ax(ax0, color_lines=color_exp, label=True, **sag_dict_data)
    ...
    plot_fi_curve_on_ax(ax0, color_line=color_exp, **fi_dict_data)
    ...
    # v_data += - v_data[0] + v_init
    v_model, t_model, _ = simulate_model(cell, 'Zap20', zap_amp, 34000 - standard_sim_params['dt'],
                                         **standard_sim_params)
    ...
    plot_impedance_on_ax(ax0, color_line=color_exp, **impedance_dict_data)
    ...
    plot_phase_hist_on_axes(ax0, 0, [sine_dict_data['phases']], plot_mean=True, color_hist=color_exp,
                            alpha=0.3, color_lines=color_exp)
