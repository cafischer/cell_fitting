...
extern Memb_func* memb_func;
 ...
 "setdata_caHVA2", _hoc_setdata,
 "efun_caHVA2", _hoc_efun,
 "rates_caHVA2", _hoc_rates,
 "trates_caHVA2", _hoc_trates,
 0, 0
};
#define efun efun_caHVA2
...
#define _gth 0
#define q10_inact q10_inact_caHVA2
 double q10_inact = 2;
#define q10_act q10_act_caHVA2
 double q10_act = 5.9;
#define tadj_inact_caHVA2 _thread1data[0]
#define tadj_inact _thread[_gth]._pval[0]
#define tadj_act_caHVA2 _thread1data[1]
#define tadj_act _thread[_gth]._pval[1]
#define temp temp_caHVA2
 double temp = 23;
#define usetable usetable_caHVA2
 double usetable = 1;
#define vshift vshift_caHVA2
 double vshift = 0;
#define vmax vmax_caHVA2
 double vmax = 100;
#define vmin vmin_caHVA2
 double vmin = -120;
 ...
 "vshift_caHVA2", &vshift_caHVA2,
 "temp_caHVA2", &temp_caHVA2,
 "q10_act_caHVA2", &q10_act_caHVA2,
 "q10_inact_caHVA2", &q10_inact_caHVA2,
 "vmin_caHVA2", &vmin_caHVA2,
 "vmax_caHVA2", &vmax_caHVA2,
 "tadj_act_caHVA2", &tadj_act_caHVA2,
 "tadj_inact_caHVA2", &tadj_inact_caHVA2,
 "usetable_caHVA2", &usetable_caHVA2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 15, 4);
 	...
 	ivoc_help("help ?1 caHVA2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/caHVA.mod\n");
...
static int _reset;
static char *modelname = "high-voltage activated calcium current";
