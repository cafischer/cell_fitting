...
if __name__ == '__main__':
    ...
    cell_ids = ['2013_12_11e', '2013_12_10c', '2013_12_10b', '2013_12_11b', '2013_12_13f', '2013_12_11a', '2013_12_11c',
             '2013_12_10d', '2013_12_13c', '2013_12_11f', '2013_12_13b']
    cells = filter(lambda id: check_rat_or_gerbil(cell_id) == animal, cell_ids)
    ...
    DAP_amps_all_cells = init_nan((len(cell_ids), len(amps)))
    DAP_deflections_all_cells = np.zeros((len(cell_ids), len(amps)))
    DAP_widths_all_cells = np.zeros((len(cell_ids), len(amps)))
    ...
    np.save(os.path.join(save_dir_summary, 'cells.npy'), np.array(cell_ids))
