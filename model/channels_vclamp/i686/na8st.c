...
extern Memb_func* memb_func;
 ...
 "setdata_na8st2", _hoc_setdata,
 "rates_na8st2", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define maxrate maxrate_na8st2
 double maxrate = 8000;
#define q10 q10_na8st2
 double q10 = 2.5;
#define tadj tadj_na8st2
 double tadj = 0;
#define temp temp_na8st2
 double temp = 23;
#define vShift_inact vShift_inact_na8st2
 double vShift_inact = 10;
#define vShift vShift_na8st2
 double vShift = 12;
 ...
 "vShift_na8st2", "mV",
 "vShift_inact_na8st2", "mV",
 "maxrate_na8st2", "/ms",
 "temp_na8st2", "degC",
 "q10_na8st2", "1",
 "tadj_na8st2", "1",
 "vshift_na8st2", "mV",
 "gbar_na8st2", "millimho/cm2",
 "a1_0_na8st2", "/ms",
 "a1_1_na8st2", "/mV",
 "b1_0_na8st2", "/ms",
 "b1_1_na8st2", "/mV",
 ...
 "ah_0_na8st2", "/ms",
 "ah_2_na8st2", "/mV",
 "vShift_inact_local_na8st2", "mV",
 "g_na8st2", "millimho/cm2",
 "ina2_na8st2", "milliamp/cm2",
 0,0
};
 static double c30 = 0;
 static double c20 = 0;
 ...
 "vShift_na8st2", &vShift_na8st2,
 "vShift_inact_na8st2", &vShift_inact_na8st2,
 "maxrate_na8st2", &maxrate_na8st2,
 "temp_na8st2", &temp_na8st2,
 "q10_na8st2", &q10_na8st2,
 "tadj_na8st2", &tadj_na8st2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 50, 4);
 	...
 	ivoc_help("help ?1 na8st2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/na8st.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 95 in file na8st.mod:\n\n"); nrn_complain(_p); abort_run(error);}
 }
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 90 in file na8st.mod:\n    SOLVE kin METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
