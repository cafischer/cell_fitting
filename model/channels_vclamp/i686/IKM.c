...
extern Memb_func* memb_func;
 ...
 "exptable_km2", _hoc_exptable,
 "evaluate_fct_km2", _hoc_evaluate_fct,
 0, 0
};
#define _f_exptable _f_exptable_km2
#define exptable exptable_km2
 extern double _f_exptable( double );
 extern double exptable( double );
 /* declare global and static user variables */
#define taumax taumax_km2
 double taumax = 1000;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 4);
 	...
 	ivoc_help("help ?1 km2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/IKM.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 62 in file IKM.mod:\n	SOLVE states METHOD euler\n"); nrn_complain(_p); abort_run(error);}
