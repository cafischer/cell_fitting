...
extern Memb_func* memb_func;
 ...
 "setdata_narsg2", _hoc_setdata,
 "rates_narsg2", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define Coff Coff_narsg2
 double Coff = 0.5;
#define Con Con_narsg2
 double Con = 0.005;
#define alpha alpha_narsg2
 double alpha = 150;
#define beta beta_narsg2
 double beta = 3;
#define x2 x2_narsg2
 double x2 = -20;
#define x1 x1_narsg2
 ...
 "Con_narsg2", &Con_narsg2,
 "Coff_narsg2", &Coff_narsg2,
 "alpha_narsg2", &alpha_narsg2,
 "beta_narsg2", &beta_narsg2,
 "x1_narsg2", &x1_narsg2,
 "x2_narsg2", &x2_narsg2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 80, 4);
 	...
 	ivoc_help("help ?1 narsg2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/narsg.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 144 in file narsg.mod:\n	SOLVE seqinitial\n"); nrn_complain(_p); abort_run(error);}
 }
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 135 in file narsg.mod:\n	SOLVE activation METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
