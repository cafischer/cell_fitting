...
variables = [
            ...
            [1, 30, [['soma', '0.5', 'ka2', 'n_vs']]],
            [-30, -1, [['soma', '0.5', 'ka', 'l_vs']]],
            [-30, -1, [['soma', '0.5', 'ka2', 'l_vs']]],
            ...
            [0, 50, [['soma', '0.5', 'ka2', 'n_tau_min']]],
            [0, 50, [['soma', '0.5', 'ka', 'l_tau_min']]],
            [0, 50, [['soma', '0.5', 'ka2', 'l_tau_min']]],
            [0, 50, [['soma', '0.5', 'nap', 'm_tau_min']]],
            [0, 50, [['soma', '0.5', 'nap', 'h_tau_min']]],

            [0, 100, [['soma', '0.5', 'nat', 'm_tau_max']]],
            [0, 100, [['soma', '0.5', 'nat', 'h_tau_max']]],
            [0, 100, [['soma', '0.5', 'ka', 'n_tau_max']]],
            [0, 100, [['soma', '0.5', 'ka2', 'n_tau_max']]],
            [0, 100, [['soma', '0.5', 'ka', 'l_tau_max']]],
            [0, 100, [['soma', '0.5', 'ka2', 'l_tau_max']]],
            [0, 100, [['soma', '0.5', 'nap', 'm_tau_max']]],
            [0, 100, [['soma', '0.5', 'nap', 'h_tau_max']]],

            [0, 10, [['soma', '0.5', 'nat', 'm_tau_delta']]],
            [0, 10, [['soma', '0.5', 'nat', 'h_tau_delta']]],
            [0, 10, [['soma', '0.5', 'ka', 'n_tau_delta']]],
            [0, 10, [['soma', '0.5', 'ka2', 'n_tau_delta']]],
            [0, 10, [['soma', '0.5', 'ka', 'l_tau_delta']]],
            [0, 10, [['soma', '0.5', 'ka2', 'l_tau_delta']]],
...
variables_init = [
            ...
            [0, 0.01, [['soma', '0.5', 'ka', 'gbar']]],
            [0, 0.01, [['soma', '0.5', 'ka2', 'gbar']]],
            [0.3, 0.5, [['soma', '0.5', 'nap', 'gbar']]],

            [-56, -54, [['soma', '0.5', 'nat', 'm_vh']]],
            [-82, -80, [['soma', '0.5', 'nat', 'h_vh']]],
            [-80, -50, [['soma', '0.5', 'ka', 'n_vh']]],
            [-80, -50, [['soma', '0.5', 'ka2', 'n_vh']]],
            [-80, -40, [['soma', '0.5', 'ka', 'l_vh']]],
            [-80, -40, [['soma', '0.5', 'ka2', 'l_vh']]],
            [-34, -32, [['soma', '0.5', 'nap', 'm_vh']]],
            [-72, -70, [['soma', '0.5', 'nap', 'h_vh']]],

            [16, 18, [['soma', '0.5', 'nat', 'm_vs']]],
            [-24, -22, [['soma', '0.5', 'nat', 'h_vs']]],
            [1, 20, [['soma', '0.5', 'ka', 'n_vs']]],
            [1, 20, [['soma', '0.5', 'ka2', 'n_vs']]],
            [-20, 1, [['soma', '0.5', 'ka', 'l_vs']]],
            [-20, 1, [['soma', '0.5', 'ka2', 'l_vs']]],
            [17, 19, [['soma', '0.5', 'nap', 'm_vs']]],
            [-14, -12, [['soma', '0.5', 'nap', 'h_vs']]],

            [0, 0.1, [['soma', '0.5', 'nat', 'm_tau_min']]],
            [0.4, 0.6, [['soma', '0.5', 'nat', 'h_tau_min']]],
            [0, 3, [['soma', '0.5', 'ka', 'n_tau_min']]],
            [0, 3, [['soma', '0.5', 'ka2', 'n_tau_min']]],
            [0, 3, [['soma', '0.5', 'ka', 'l_tau_min']]],
            [0, 3, [['soma', '0.5', 'ka2', 'l_tau_min']]],
            ...
            [1, 50, [['soma', '0.5', 'ka2', 'n_tau_max']]],
            [1, 100, [['soma', '0.5', 'ka', 'l_tau_max']]],
            [1, 100, [['soma', '0.5', 'ka2', 'l_tau_max']]],
            ...
            [0, 1, [['soma', '0.5', 'ka2', 'n_tau_delta']]],
            [0, 1, [['soma', '0.5', 'ka', 'l_tau_delta']]],
            [0, 1, [['soma', '0.5', 'ka2', 'l_tau_delta']]],
...
fitter_params = {
                    ...
                    'simulation_params': [
                                         {'celsius': 35, 'onset': 200, 'atol': 1e-6, 'continuous': True,
