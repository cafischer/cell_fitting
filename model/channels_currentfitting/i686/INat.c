...
extern Memb_func* memb_func;
 ...
 "Exp_Nat", _hoc_Exp,
 "evaluate_fct_Nat", _hoc_evaluate_fct,
 "states_Nat", _hoc_states,
 "vtrap_Nat", _hoc_vtrap,
 0, 0
};
#define Exp Exp_Nat
#define vtrap vtrap_Nat
 extern double Exp( double );
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define celsius_channel celsius_channel_Nat
 double celsius_channel = 21.5;
#define q10_inact q10_inact_Nat
 double q10_inact = 1.3;
#define q10_act q10_act_Nat
 double q10_act = 2.7;
 ...
 "q10_act_Nat", &q10_act_Nat,
 "q10_inact_Nat", &q10_inact_Nat,
 "celsius_channel_Nat", &celsius_channel_Nat,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 20, 6);
 	...
 	ivoc_help("help ?1 Nat /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels/i686/INat.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("Nat", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 73 in file INat.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
