...
extern Memb_func* memb_func;
 ...
 "efun_caLVA", _hoc_efun,
 "evaluate_fct_caLVA", _hoc_evaluate_fct,
 "ghk_caLVA", _hoc_ghk,
 "nongat_caLVA", _hoc_nongat,
 0, 0
};
#define efun efun_caLVA
#define ghk ghk_caLVA
#define nongat nongat_caLVA
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 18, 5);
 	...
 	ivoc_help("help ?1 caLVA /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels/stellate/i686/caLVA.mod\n");
