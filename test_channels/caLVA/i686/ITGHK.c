...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 18, 5);
 	...
 	ivoc_help("help ?1 itGHK /media/caro/Daten/Phd/DAP-Project/cell_fitting/test_channels/Cat/i686/ITGHK.mod\n");
...
double nongat ( _threadargsprotocomma_ double _lv , double _lcai , double _lcao ) {
   double _lnongat;
 _lnongat = gbar * ghk ( _threadargscomma_ _lv , _lcai , _lcao ) ;
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = gbar * m * m * h * ghk ( _threadargscomma_ v , cai , cao ) ;
   }
 _current += ica;
