...
#define q10 q10_kca2
 double q10 = 1.6;
#define temp temp_kca2
 double temp = 20;
#define usetable usetable_kca2
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 12, 4);
 	...
 	ivoc_help("help ?1 kca2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/kca.mod\n");
...
static int _reset;
static char *modelname = "Potassium C type current for RD Traub, J Neurophysiol 89:909-921, 2003";
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   ...
   if ( _lv < - 10.0 ) {
     alpha = ( 2.0 / 37.95 * ( exp ( ( _lv + 50.0 ) / 11.0 - ( _lv + 53.5 ) / 27.0 ) ) ) / tadj ;
     beta = ( 2.0 * exp ( ( - _lv - 53.5 ) / 27.0 ) - alpha ) / tadj ;
     }
   else {
     alpha = ( 2.0 * exp ( ( - _lv - 53.5 ) / 27.0 ) ) / tadj ;
     beta = 0.0 ;
     }
    return 0; }
