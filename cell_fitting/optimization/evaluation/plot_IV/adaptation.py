...
from cell_fitting.data.plot_IV.adaptation import get_trace_with_n_APs, fit_fun
pl.style.use('paper')
...
if __name__ == '__main__':
    ...
    cell_id = '2015_08_26b'
    save_dir_data = '../../../data/plots/plot_IV/adaptation/rat/summary'
    model_ids = range(1, 7)
    ...
    for mi, model_id in enumerate(model_ids):
        ...
        # plot
        save_dir_img_model = os.path.join(save_dir_model, 'img', 'plot_IV', 'adaptation')
    ...
    # plot
    save_dir_img = os.path.join(save_dir, 'img', 'plot_IV', 'adaptation')
