...
if __name__ == '__main__':
    ...
    save_dir_data = os.path.join('../../../data/plots/sine_stimulus/traces/', 'rat', 'summary', 'spike_phase',
                                 'amp1_amp2_'+str(freq1)+'_'+str(freq2))
    ...
    jp = sns.jointplot('Mean Phase', 'Std Phase', data=data, stat_func=None, color='k')
...
# TODO: put phase precession back in again or make new file with !