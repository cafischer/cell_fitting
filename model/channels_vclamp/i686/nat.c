...
extern Memb_func* memb_func;
 ...
 "setdata_nat2", _hoc_setdata,
 "efun_nat2", _hoc_efun,
 "rates_nat2", _hoc_rates,
 "trates_nat2", _hoc_trates,
 0, 0
};
#define efun efun_nat2
...
#define q10 q10_nat2
 double q10 = 3;
#define qinf qinf_nat2
 double qinf = 6.2;
#define qi qi_nat2
 double qi = 5;
#define qa qa_nat2
 double qa = 9;
#define tadj_nat2 _thread1data[0]
#define tadj _thread[_gth]._pval[0]
#define temp temp_nat2
 double temp = 23;
#define thinf thinf_nat2
 double thinf = -65;
#define thi2 thi2_nat2
 double thi2 = -75;
#define thi1 thi1_nat2
 double thi1 = -50;
#define tha tha_nat2
 double tha = -35;
#define usetable usetable_nat2
 double usetable = 1;
#define vmax vmax_nat2
 double vmax = 100;
#define vmin vmin_nat2
 double vmin = -120;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 16, 4);
 	...
 	ivoc_help("help ?1 nat2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/nat.mod\n");
