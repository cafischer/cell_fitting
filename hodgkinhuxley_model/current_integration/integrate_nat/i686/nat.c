...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 nat /media/caro/Daten/Phd/DAP-Project/cell_fitting/fit_currents/current_integration/integrate_nat/i686/nat.mod\n");
...
/*CVODE*/
 ...
 static double _mfac_trates, _tmin_trates;
  ...
  if (_maktable) { double _x, _dx; _maktable=0;
   _tmin_trates =  vmin ;
   _tmax =  vmax ;
   _dx = (_tmax - _tmin_trates)/1000.; _mfac_trates = 1./_dx;
   for (_i=0, _x=_tmin_trates; _i < 1001; _x += _dx, _i++) {
