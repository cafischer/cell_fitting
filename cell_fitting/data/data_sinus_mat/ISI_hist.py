...
if __name__ == '__main__':
    ...
    animal = 'rat'
    save_dir_img = os.path.join('../plots/sine_stimulus', 'ISI_hist', animal)
    ...
    for cell_id in cell_ids:
        ...
        for i_trace in range(len(vs)):
            ...
            save_dir_cell = os.path.join('../plots/sine_stimulus', 'ISI_hist', animal, cell_id,
            ...
            plot_ISI_hist(ISI_hist, bins, save_dir_cell)
            ...
            pl.savefig(os.path.join(save_dir_cell, 'n_APs_per_up.png'))
            #pl.show()
            ...
            with open(os.path.join(save_dir_cell, 'n_APs_in_out.txt'), 'w') as f:
