...
extern Memb_func* memb_func;
 ...
 "setdata_hhc", _hoc_setdata,
 "rates_hhc", _hoc_rates,
 "vtrap_hhc", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_hhc
...
#define _gth 0
#define htau_hhc _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hhc _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hhc _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hhc _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hhc _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hhc _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_hhc
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 19, 7);
 	...
 	ivoc_help("help ?1 hhc /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels/i686/hh.mod\n");
