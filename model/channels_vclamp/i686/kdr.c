...
extern Memb_func* memb_func;
 ...
 "alpn_kdr2", _hoc_alpn,
 "betn_kdr2", _hoc_betn,
 "rates_kdr2", _hoc_rates,
 0, 0
};
#define alpn alpn_kdr2
#define betn betn_kdr2
...
#define gmn gmn_kdr2
 double gmn = 0.7;
#define nmin nmin_kdr2
 double nmin = 1;
#define nscale nscale_kdr2
 double nscale = 1;
#define q10 q10_kdr2
 double q10 = 1;
#define temp temp_kdr2
 double temp = 24;
#define vhalfn vhalfn_kdr2
 double vhalfn = 13;
#define zetan zetan_kdr2
 double zetan = -3;
 ...
 "temp_kdr2", &temp_kdr2,
 "vhalfn_kdr2", &vhalfn_kdr2,
 "a0n_kdr2", &a0n_kdr2,
 "zetan_kdr2", &zetan_kdr2,
 "gmn_kdr2", &gmn_kdr2,
 "nmin_kdr2", &nmin_kdr2,
 "q10_kdr2", &q10_kdr2,
 "nscale_kdr2", &nscale_kdr2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 11, 4);
 	...
 	ivoc_help("help ?1 kdr2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/kdr.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "delayed-rectifier potassium current";
