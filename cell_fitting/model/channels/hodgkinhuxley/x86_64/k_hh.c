...
extern Memb_func* memb_func;
 ...
 "setdata_k_hh", _hoc_setdata,
 "rates_k_hh", _hoc_rates,
 "vtrap_k_hh", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_k_hh
...
#define _gth 0
#define ntau_k_hh _thread1data[0]
#define ntau _thread[_gth]._pval[0]
#define ninf_k_hh _thread1data[1]
#define ninf _thread[_gth]._pval[1]
#define usetable usetable_k_hh
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 8, 4);
 	...
 	ivoc_help("help ?1 k_hh /home/cf/Phd/programming/projects/cell_fitting/cell_fitting/model/channels/hodgkinhuxley/x86_64/k_hh.mod\n");
