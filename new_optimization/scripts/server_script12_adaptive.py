...
variables = [
            ...
            [0, 0.5, [['soma', '0.5', 'kdr2', 'gbar']]],
            [0, 0.5, [['soma', '0.5', 'nap', 'gbar']]],

            [-100, 0, [['soma', '0.5', 'kdr', 'n_vh']]],
            [-100, 0, [['soma', '0.5', 'kdr2', 'n_vh']]],

            [1, 30, [['soma', '0.5', 'kdr', 'n_vs']]],
            [1, 30, [['soma', '0.5', 'kdr2', 'n_vs']]],

            [0, 50, [['soma', '0.5', 'kdr', 'n_tau_min']]],
            [0, 50, [['soma', '0.5', 'kdr2', 'n_tau_min']]],

            [0, 100, [['soma', '0.5', 'kdr', 'n_tau_max']]],
            [0, 100, [['soma', '0.5', 'kdr2', 'n_tau_max']]],

            [0, 10, [['soma', '0.5', 'kdr', 'n_tau_delta']]],
            [0, 10, [['soma', '0.5', 'kdr2', 'n_tau_delta']]],
            ]
...
variables_init = [
            ...
            [0.001, 0.05, [['soma', '0.5', 'kdr', 'gbar']]],
            [0.001, 0.05, [['soma', '0.5', 'kdr2', 'gbar']]],
            [0.3, 0.5, [['soma', '0.5', 'nap', 'gbar']]],

            [-75, -55, [['soma', '0.5', 'kdr', 'n_vh']]],
            [-75, -55, [['soma', '0.5', 'kdr2', 'n_vh']]],

            [5, 20, [['soma', '0.5', 'kdr', 'n_vs']]],
            [5, 20, [['soma', '0.5', 'kdr2', 'n_vs']]],

            [0, 1, [['soma', '0.5', 'kdr', 'n_tau_min']]],
            [0, 1, [['soma', '0.5', 'kdr2', 'n_tau_min']]],

            [1, 30, [['soma', '0.5', 'kdr', 'n_tau_max']]],
            [1, 30, [['soma', '0.5', 'kdr2', 'n_tau_max']]],

            [0.1, 1, [['soma', '0.5', 'kdr', 'n_tau_delta']]],
            [0.1, 1, [['soma', '0.5', 'kdr2', 'n_tau_delta']]],
            ]
