...
extern Memb_func* memb_func;
 ...
 "setdata_CAlM95", _hoc_setdata,
 "KTF_CAlM95", _hoc_KTF,
 "alp_CAlM95", _hoc_alp,
 "bet_CAlM95", _hoc_bet,
 "efun_CAlM95", _hoc_efun,
 "ghk_CAlM95", _hoc_ghk,
 "h2_CAlM95", _hoc_h2,
 "rate_CAlM95", _hoc_rate,
 0, 0
};
#define KTF KTF_CAlM95
#define _f_bet _f_bet_CAlM95
#define _f_alp _f_alp_CAlM95
#define alp alp_CAlM95
#define bet bet_CAlM95
#define efun efun_CAlM95
#define ghk ghk_CAlM95
#define h2 h2_CAlM95
...
#define ki ki_CAlM95
 double ki = 0.001;
#define minf minf_CAlM95
 double minf = 0;
#define tfa tfa_CAlM95
 double tfa = 1;
#define tau tau_CAlM95
 double tau = 0;
#define usetable usetable_CAlM95
 double usetable = 1;
 ...
 "ki_CAlM95", &ki_CAlM95,
 "tfa_CAlM95", &tfa_CAlM95,
 "minf_CAlM95", &minf_CAlM95,
 "tau_CAlM95", &tau_CAlM95,
 "usetable_CAlM95", &usetable_CAlM95,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 8, 5);
 	...
 	ivoc_help("help ?1 CAlM95 /media/caro/Daten/Phd/DAP-Project/cell_fitting/test_channels/CaHVA/i686/CAlM95.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   gcal = gbar * m * m * h2 ( _threadargscomma_ cai ) ;
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 41 in file CAlM95.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
