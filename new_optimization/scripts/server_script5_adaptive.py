...
discontinuities_PP4 = [start_step, end_step]
...
fitter_params = {
                    ...
                    'simulation_params': [
                                          ...
                                          'discontinuities': discontinuities_PP4, 'interpolate': True},
                                          {'celsius': 35, 'onset': 200, 'atol': 1e-8, 'continuous': True,
...
optimization_settings_dict = {
    'maximize': False,
    'n_candidates': 2,  #100000,
    'stop_criterion': ['generation_termination', 2], #1000],
    'seed': time(),
...
algorithm_settings_dict = {
    ...
    'optimization_params': {},
    'normalize': False,
    'save_dir': os.path.join(save_dir, '0') #os.path.join(save_dir, sys.argv[2])
}
