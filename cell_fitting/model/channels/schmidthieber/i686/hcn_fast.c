...
extern Memb_func* memb_func;
 ...
 "setdata_ih_fast", _hoc_setdata,
 "settables_ih_fast", _hoc_settables,
 0, 0
};
...
#define ehcn ehcn_ih_fast
 double ehcn = -20;
#define mife mife_ih_fast
 double mife = 1.36;
#define mifd mifd_ih_fast
 double mifd = 9.78;
#define mifo mifo_ih_fast
 double mifo = 74.2;
#define taufrd taufrd_ih_fast
 double taufrd = 52;
#define taufro taufro_ih_fast
 double taufro = 340;
#define taufdd taufdd_ih_fast
 double taufdd = 10;
#define taufdo taufdo_ih_fast
 double taufdo = 1.7;
#define taufn taufn_ih_fast
 double taufn = 0.51;
#define usetable usetable_ih_fast
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ih_fast", 0, 1,
 0,0,0
};
 ...
 "ehcn_ih_fast", &ehcn_ih_fast,
 "taufn_ih_fast", &taufn_ih_fast,
 "taufdo_ih_fast", &taufdo_ih_fast,
 "taufdd_ih_fast", &taufdd_ih_fast,
 "taufro_ih_fast", &taufro_ih_fast,
 "taufrd_ih_fast", &taufrd_ih_fast,
 "mifo_ih_fast", &mifo_ih_fast,
 "mifd_ih_fast", &mifd_ih_fast,
 "mife_ih_fast", &mife_ih_fast,
 "usetable_ih_fast", &usetable_ih_fast,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 8, 1);
 	...
 	ivoc_help("help ?1 ih_fast /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels/schmidthieber/i686/hcn_fast.mod\n");
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   double _lmif , _ltauf ;
 _ltauf = taufn / ( exp ( ( _lv - taufdo ) / taufdd ) + exp ( - ( _lv + taufro ) / taufrd ) ) ;
