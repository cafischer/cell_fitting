...
from cell_fitting.new_optimization.evaluation.sigmoid import sig_upper_half
pl.style.use('paper')
...
if __name__ == '__main__':
    ...
    currents = []
    for a in a_range:
        i_inj = sig_upper_half(shift_sig, 1+shift_sig, a, x)
    ...
    # plot
    save_img = os.path.join(save_dir, 'img', 'IV', 'sigmoid_step', 'upper_half', 'shift_sig')
