...
#define Dl _p[13]
#define ik _p[14]
#define tadj_act _p[15]
#define tadj_inact _p[16]
#define v _p[17]
#define _g _p[18]
...
extern Memb_func* memb_func;
 ...
 "betl_ka2", _hoc_betl,
 "betn_ka2", _hoc_betn,
 "rates_ka2", _hoc_rates,
 0, 0
};
#define alpl alpl_ka2
#define alpn alpn_ka2
#define betl betl_ka2
#define betn betn_ka2
...
#define gmn gmn_ka2
 double gmn = 0.55;
#define lscale lscale_ka2
 double lscale = 1;
#define lmin lmin_ka2
 double lmin = 2;
#define nmin nmin_ka2
 double nmin = 0.1;
#define nscale nscale_ka2
 double nscale = 1;
#define pw pw_ka2
 double pw = -1;
#define q10_inact q10_inact_ka2
 double q10_inact = 1;
#define q10_act q10_act_ka2
 double q10_act = 5;
#define qq qq_ka2
 double qq = 5;
#define temp temp_ka2
 double temp = 24;
#define tq tq_ka2
 double tq = -40;
#define zetal zetal_ka2
 double zetal = 3;
#define zetan zetan_ka2
 double zetan = -1.5;
 ...
 "qq_ka2", &qq_ka2,
 "nmin_ka2", &nmin_ka2,
 "nscale_ka2", &nscale_ka2,
 "a0l_ka2", &a0l_ka2,
 "zetal_ka2", &zetal_ka2,
 "lmin_ka2", &lmin_ka2,
 "lscale_ka2", &lscale_ka2,
 "q10_act_ka2", &q10_act_ka2,
 "q10_inact_ka2", &q10_inact_ka2,
 "temp_ka2", &temp_ka2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 19, 4);
 	...
 	ivoc_help("help ?1 ka2 /media/caro/Daten/Phd/DAP-Project/cell_fitting/model/channels_without_output/i686/ka.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "A-type potassium current";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _la , _ltadj_act , _ltadj_inact ;
 _ltadj_act = pow( q10_act , ( ( celsius - temp ) / 10.0 ) ) ;
   _la = alpn ( _threadargscomma_ _lv ) ;
   ninf = 1.0 / ( 1.0 + _la ) ;
   taun = ( betn ( _threadargscomma_ _lv ) / ( a0n * ( 1.0 + _la ) ) ) / _ltadj_act ;
   if ( taun < nmin ) {
     taun = nmin ;
     }
   taun = taun / nscale ;
   _ltadj_inact = pow( q10_inact , ( ( celsius - temp ) / 10.0 ) ) ;
   _la = alpl ( _threadargscomma_ _lv ) ;
   linf = 1.0 / ( 1.0 + _la ) ;
   taul = ( 0.26 * ( _lv + 50.0 ) ) / _ltadj_inact ;
   if ( taul < lmin ) {
     taul = lmin ;
     }
   taul = taul / lscale ;
