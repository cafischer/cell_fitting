...
PROCEDURE settables(v) { 
    ...
    alpha_h = (a_alpha_h * v + b_alpha_h) / (1 - exp((v + b_alpha_h / a_alpha_h) / k_alpha_h)) / 1000
    beta_h = (a_beta_h * v + b_beta_h) / (1 - exp((v + b_beta_h / a_beta_h) / k_beta_h)) / 1000
